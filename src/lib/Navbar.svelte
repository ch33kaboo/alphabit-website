...
<nav
    class="sticky top-0 flex w-full select-none items-center justify-between overflow-x-hidden bg-blue-200 bg-opacity-50 py-5 backdrop-blur-md dark:bg-gray-800 dark:bg-opacity-50"
>
    <button
