...
<div class="modal">
    <div class="modal-box bg-gray-200 text-black">
        ...
        <div class="flex flex-col divide-y">
            <div>
                <p class="-mb-2 flex items-center justify-start gap-3 py-4">
                    <svg
                ...
                <p class="-mt-5 flex items-center justify-start gap-3 py-4">
                    <svg
                        width="24"
                        height="24"
                        xmlns="http://www.w3.org/2000/svg"
                        ...
                        /></svg
                    ><a>mc.ouzane@esi-sba.dz</a>
                </p>
            </div>

            <div>
                <h3 class="pt-4 text-lg font-bold">
                    or check my other projects from here :
                </h3>
                <p class="flex items-center justify-start gap-3 py-4">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
        ...
        <div class="modal-action">
            <label for="my-modal" class="btn text-white">Got it</label>
        </div>
    </div>
</div>
